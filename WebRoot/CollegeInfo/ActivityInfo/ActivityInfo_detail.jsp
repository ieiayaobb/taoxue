...
<script type="text/javascript">
	$(document).ready(function(){
		...
		for(var i=0;i<activityInfos.length;i++){
			...
			li+="<a href=\"${path}/CollegeInfo/ActivityInfo/ActivityInfo!ToDetail.action?id="+activityInfos[i].id+"&type="+activityInfos[i].type+"\">"+activityInfos[i].name+"</a></li>"
			$("#listDemo").append(li);
		}
		var temp;
